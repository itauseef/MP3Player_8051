...
Forked By - Tauseef Indikar & Gaurav Shukla
Created on - 3/18/2015

For - ESD S15

------***------***------
This is a fork of elm-chans tiny-fat-filesystem module
Reference:
http://elm-chan.org/fsw/ff/00index_e.html
-- All the functions from the above reference have been modified/optimized to suit SDCC 2.6.0 and MCS51

The following functions are added and are based on f_read():
1)f_mp3_read
2)f_txt_read
------***------***------
**/
...
FRESULT f_mp3_read (FIL*, void*, UINT, UINT*);	    /* Read data from a file */
FRESULT f_txt_read (FIL*, void*, UINT, UINT*);		/* Read data from a file */
