   ...
   0003                     452 	.ds 1
                    ...
                    3000    455 _xbuffer	=	0x3000
                            ...
                            485 	.area CSEG    (CODE)
                            486 ;------------------------------------------------------------
                            487 ;Allocation info for local variables in function 'SPI_Byte'
                            488 ;------------------------------------------------------------
                            489 ;ThisByte                  Allocated to registers 
                            490 ;------------------------------------------------------------
                            491 ;	Drivers/driver_spi.c:22: BYTE SPI_Byte( BYTE ThisByte )
                            492 ;	-----------------------------------------
                            493 ;	 function SPI_Byte
                            494 ;	-----------------------------------------
   03AD                     495 _SPI_Byte:
                    0002    496 	ar2 = 0x02
                    0003    497 	ar3 = 0x03
                    ...
                    0001    503 	ar1 = 0x01
                            504 ;	genReceive
   03AD 85 82 C5            505 	mov	_SPDAT,dpl
                            506 ;	Drivers/driver_spi.c:25: SPIWait();
   03B0                     507 00101$:
                            508 ;	genAnd
   03B0 E5 C4               509 	mov	a,_SPSTA
                            510 ;	genIfxJump
                            511 ;	Peephole 108.d	removed ljmp by inverse jump logic
   03B2 30 E7 FB            512 	jnb	acc.7,00101$
                            513 ;	Peephole 300	removed redundant label 00108$
                            514 ;	Drivers/driver_spi.c:26: return SPIGetChar;
                            515 ;	genRet
   03B5 85 C5 82            516 	mov	dpl,_SPDAT
                            517 ;	Peephole 300	removed redundant label 00104$
   03B8 22                  518 	ret
                            519 ;------------------------------------------------------------
                            520 ;Allocation info for local variables in function 'SPI_nClocks'
                            521 ;------------------------------------------------------------
                            522 ;nClocks                   Allocated to registers r2 
                            523 ;------------------------------------------------------------
                            524 ;	Drivers/driver_spi.c:30: void SPI_nClocks(unsigned char nClocks)
                            525 ;	-----------------------------------------
                            526 ;	 function SPI_nClocks
                            527 ;	-----------------------------------------
   03B9                     528 _SPI_nClocks:
                            529 ;	genReceive
   03B9 AA 82               530 	mov	r2,dpl
                            531 ;	Drivers/driver_spi.c:32: while (nClocks--)
                            532 ;	genAssign
   03BB                     533 00101$:
                            534 ;	genAssign
   03BB 8A 03               535 	mov	ar3,r2
                            536 ;	genMinus
                            537 ;	genMinusDec
   03BD 1A                  538 	dec	r2
                            539 ;	genIfx
   03BE EB                  540 	mov	a,r3
                            541 ;	genIfxJump
                            542 ;	Peephole 108.c	removed ljmp by inverse jump logic
   03BF 60 05               543 	jz	00104$
                            544 ;	Peephole 300	removed redundant label 00113$
                            545 ;	Drivers/driver_spi.c:33: SPIPutChar(0xFF);       // Send SD Card - (8 clock cycles)
                            546 ;	genAssign
   03C1 75 C5 FF            547 	mov	_SPDAT,#0xFF
                            548 ;	Drivers/driver_spi.c:34: SPIWait();
                            549 ;	Peephole 112.b	changed ljmp to sjmp
   03C4 80 F5               550 	sjmp	00101$
   03C6                     551 00104$:
                            552 ;	genAnd
   03C6 E5 C4               553 	mov	a,_SPSTA
                            554 ;	genIfxJump
                            555 ;	Peephole 108.d	removed ljmp by inverse jump logic
   03C8 30 E7 FB            556 	jnb	acc.7,00104$
                            557 ;	Peephole 300	removed redundant label 00114$
                            558 ;	Peephole 300	removed redundant label 00107$
   03CB 22                  559 	ret
                            560 	.area CSEG    (CODE)
                            561 	.area CONST   (CODE)
                            562 	.area XINIT   (CODE)
