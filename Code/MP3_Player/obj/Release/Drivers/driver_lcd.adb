M:driver_lcd
F:G$send_command$0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lsend_command$cmd$1$1({1}SC:S),R,0,0,[r2]
F:G$lcdinit$0$0({2}DF,SV:S),Z,0,0,0,0,0
F:G$lcdgotoaddr$0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Llcdgotoaddr$addr$1$1({1}SC:U),R,0,0,[r2]
F:G$lcdgotoxy$0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Llcdgotoxy$column$1$1({1}SC:U),B,1,-3
S:Llcdgotoxy$row$1$1({1}SC:U),R,0,0,[r2]
F:G$lcdputch$0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Llcdputch$value$1$1({1}SC:S),R,0,0,[r2]
S:Llcdputch$row$1$1({1}SC:U),R,0,0,[r3]
S:Llcdputch$cursor_loc$1$1({1}SC:U),R,0,0,[r2]
F:G$lcdputstr_currloc$0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Llcdputstr_currloc$string$1$1({3}DG,SC:S),R,0,0,[r2,r3,r4]
F:G$lcdputstr$0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Llcdputstr$string$1$1({3}DG,SC:S),R,0,0,[r2,r3,r4]
F:G$get_lcd_addr$0$0({2}DF,SC:U),Z,0,0,0,0,0
S:Lget_lcd_addr$address$1$1({1}SC:U),R,0,0,[]
T:Fdriver_lcd$_FIL[({0}S:S$id$0$0({2}SI:U),Z,0,0)({2}S:S$flag$0$0({1}SC:U),Z,0,0)({3}S:S$sect_clust$0$0({1}SC:U),Z,0,0)({4}S:S$fs$0$0({3}DG,ST_FATFS:S),Z,0,0)({7}S:S$fptr$0$0({4}SL:U),Z,0,0)({11}S:S$fsize$0$0({4}SL:U),Z,0,0)({15}S:S$org_clust$0$0({4}SL:U),Z,0,0)({19}S:S$curr_clust$0$0({4}SL:U),Z,0,0)({23}S:S$curr_sect$0$0({4}SL:U),Z,0,0)]
T:Fdriver_lcd$_DIR[({0}S:S$id$0$0({2}SI:U),Z,0,0)({2}S:S$index$0$0({2}SI:U),Z,0,0)({4}S:S$fs$0$0({3}DG,ST_FATFS:S),Z,0,0)({7}S:S$sclust$0$0({4}SL:U),Z,0,0)({11}S:S$clust$0$0({4}SL:U),Z,0,0)({15}S:S$sect$0$0({4}SL:U),Z,0,0)]
T:Fdriver_lcd$__00010000[({0}S:S$Index$0$0({6}DA6,SC:U),Z,0,0)({0}S:S$CA$0$0({6}ST__00020001:S),Z,0,0)]
T:Fdriver_lcd$__00010002[({0}S:S$b$0$0({4}DA4,SC:U),Z,0,0)({0}S:S$ul$0$0({4}SL:U),Z,0,0)]
T:Fdriver_lcd$__00020001[({0}S:S$Command$1$0({1}SC:U),Z,0,0)({1}S:S$Argument$1$0({4}SL:U),Z,0,0)({5}S:S$Cksum$1$0({1}SC:U),Z,0,0)]
T:Fdriver_lcd$_FILINFO[({0}S:S$fsize$0$0({4}SL:U),Z,0,0)({4}S:S$fdate$0$0({2}SI:U),Z,0,0)({6}S:S$ftime$0$0({2}SI:U),Z,0,0)({8}S:S$fattrib$0$0({1}SC:U),Z,0,0)({9}S:S$fname$0$0({13}DA13,SC:S),Z,0,0)]
T:Fdriver_lcd$_FATFS[({0}S:S$id$0$0({2}SI:U),Z,0,0)({2}S:S$n_rootdir$0$0({2}SI:U),Z,0,0)({4}S:S$winsect$0$0({4}SL:U),Z,0,0)({8}S:S$fatbase$0$0({4}SL:U),Z,0,0)({12}S:S$dirbase$0$0({4}SL:U),Z,0,0)({16}S:S$database$0$0({4}SL:U),Z,0,0)({20}S:S$sects_fat$0$0({4}SL:U),Z,0,0)({24}S:S$max_clust$0$0({4}SL:U),Z,0,0)({28}S:S$fs_type$0$0({1}SC:U),Z,0,0)({29}S:S$sects_clust$0$0({1}SC:U),Z,0,0)({30}S:S$n_fats$0$0({1}SC:U),Z,0,0)({31}S:S$winflag$0$0({1}SC:U),Z,0,0)({32}S:S$win$0$0({512}DA512,SC:U),Z,0,0)]
T:Fdriver_lcd$MAH[({0}S:S$next$0$0({2}DX,STMAH:S),Z,0,0)({2}S:S$len$0$0({2}SI:U),Z,0,0)({4}S:S$mem$0$0({0}DA0,SC:U),Z,0,0)]
S:Fdriver_lcd$lcdinstwrptr$0$0({1}SC:U),F,0,0
S:Fdriver_lcd$lcdinstrdptr$0$0({1}SC:U),F,0,0
S:Fdriver_lcd$lcddatawrptr$0$0({1}SC:U),F,0,0
S:Fdriver_lcd$lcddatardptr$0$0({1}SC:U),F,0,0
