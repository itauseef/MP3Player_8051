...
F:G$i2c_stop$0$0({2}DF,SV:S),Z,0,0,0,0,0
F:G$i2c_clock$0$0({2}DF,SV:S),Z,0,0,0,0,0
F:G$get_i2c_bit$0$0({2}DF,SB0$1:U),Z,0,0,0,0,0
S:Lget_i2c_bit$rcv$1$1({1}SB0$1:U),R,0,0,[]
F:G$put_i2c_byte$0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lput_i2c_byte$cc$1$1({1}SC:U),R,0,0,[r2]
S:Lput_i2c_byte$i$1$1({1}SC:U),R,0,0,[r3]
F:G$get_i2c_byte$0$0({2}DF,SC:U),Z,0,0,0,0,0
S:Lget_i2c_byte$i$1$1({1}SC:U),R,0,0,[r3]
S:Lget_i2c_byte$cc$1$1({1}SC:U),R,0,0,[r2]
T:Fdriver_i2c$_FIL[({0}S:S$id$0$0({2}SI:U),Z,0,0)({2}S:S$flag$0$0({1}SC:U),Z,0,0)({3}S:S$sect_clust$0$0({1}SC:U),Z,0,0)({4}S:S$fs$0$0({3}DG,ST_FATFS:S),Z,0,0)({7}S:S$fptr$0$0({4}SL:U),Z,0,0)({11}S:S$fsize$0$0({4}SL:U),Z,0,0)({15}S:S$org_clust$0$0({4}SL:U),Z,0,0)({19}S:S$curr_clust$0$0({4}SL:U),Z,0,0)({23}S:S$curr_sect$0$0({4}SL:U),Z,0,0)]
T:Fdriver_i2c$_DIR[({0}S:S$id$0$0({2}SI:U),Z,0,0)({2}S:S$index$0$0({2}SI:U),Z,0,0)({4}S:S$fs$0$0({3}DG,ST_FATFS:S),Z,0,0)({7}S:S$sclust$0$0({4}SL:U),Z,0,0)({11}S:S$clust$0$0({4}SL:U),Z,0,0)({15}S:S$sect$0$0({4}SL:U),Z,0,0)]
T:Fdriver_i2c$__00010000[({0}S:S$Index$0$0({6}DA6,SC:U),Z,0,0)({0}S:S$CA$0$0({6}ST__00020001:S),Z,0,0)]
T:Fdriver_i2c$__00010002[({0}S:S$b$0$0({4}DA4,SC:U),Z,0,0)({0}S:S$ul$0$0({4}SL:U),Z,0,0)]
T:Fdriver_i2c$__00020001[({0}S:S$Command$1$0({1}SC:U),Z,0,0)({1}S:S$Argument$1$0({4}SL:U),Z,0,0)({5}S:S$Cksum$1$0({1}SC:U),Z,0,0)]
T:Fdriver_i2c$_FILINFO[({0}S:S$fsize$0$0({4}SL:U),Z,0,0)({4}S:S$fdate$0$0({2}SI:U),Z,0,0)({6}S:S$ftime$0$0({2}SI:U),Z,0,0)({8}S:S$fattrib$0$0({1}SC:U),Z,0,0)({9}S:S$fname$0$0({13}DA13,SC:S),Z,0,0)]
T:Fdriver_i2c$_FATFS[({0}S:S$id$0$0({2}SI:U),Z,0,0)({2}S:S$n_rootdir$0$0({2}SI:U),Z,0,0)({4}S:S$winsect$0$0({4}SL:U),Z,0,0)({8}S:S$fatbase$0$0({4}SL:U),Z,0,0)({12}S:S$dirbase$0$0({4}SL:U),Z,0,0)({16}S:S$database$0$0({4}SL:U),Z,0,0)({20}S:S$sects_fat$0$0({4}SL:U),Z,0,0)({24}S:S$max_clust$0$0({4}SL:U),Z,0,0)({28}S:S$fs_type$0$0({1}SC:U),Z,0,0)({29}S:S$sects_clust$0$0({1}SC:U),Z,0,0)({30}S:S$n_fats$0$0({1}SC:U),Z,0,0)({31}S:S$winflag$0$0({1}SC:U),Z,0,0)({32}S:S$win$0$0({512}DA512,SC:U),Z,0,0)]
T:Fdriver_i2c$MAH[({0}S:S$next$0$0({2}DX,STMAH:S),Z,0,0)({2}S:S$len$0$0({2}SI:U),Z,0,0)({4}S:S$mem$0$0({0}DA0,SC:U),Z,0,0)]
S:Fdriver_i2c$lcdinstwrptr$0$0({1}SC:U),F,0,0
S:Fdriver_i2c$lcdinstrdptr$0$0({1}SC:U),F,0,0
S:Fdriver_i2c$lcddatawrptr$0$0({1}SC:U),F,0,0
S:Fdriver_i2c$lcddatardptr$0$0({1}SC:U),F,0,0
