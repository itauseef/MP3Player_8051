M:sd
F:G$SD_GetR1$0$0({2}DF,SC:U),Z,0,0,0,0,0
S:LSD_GetR1$i$1$1({1}SC:U),R,0,0,[r3]
S:LSD_GetR1$j$1$1({1}SC:U),R,0,0,[r2]
F:G$SD_GetR2$0$0({2}DF,SI:U),Z,0,0,0,0,0
F:G$SD_Command$0$0({2}DF,SC:U),Z,0,4,0,0,0
S:LSD_Command$ThisArgument$1$1({4}SL:U),B,1,-6
S:LSD_Command$ThisCommand$1$1({1}SC:U),R,0,0,[r2]
S:LSD_Command$Temp$1$1({4}ST__00010002:S),B,1,1
S:LSD_Command$i$1$1({1}SC:U),R,0,0,[r3]
F:G$Delay$0$0({2}DF,SV:S),Z,0,0,0,0,0
S:LDelay$MilSec$1$1({2}SI:U),R,0,0,[r2,r3]
S:LDelay$i$1$1({2}SI:U),R,0,0,[r6,r7]
S:LDelay$j$1$1({2}SI:U),R,0,0,[r4,r5]
F:G$SD_Init$0$0({2}DF,SC:U),Z,0,0,0,0,0
S:LSD_Init$CardStatus$1$1({2}SI:U),R,0,0,[r2,r3]
S:LSD_Init$Count$1$1({2}SI:U),R,0,0,[r2,r3]
F:G$SD_ReadSector$0$0({2}DF,SC:U),Z,0,0,0,0,0
S:LSD_ReadSector$Buffer$1$1({3}DG,SC:U),B,1,-5
S:LSD_ReadSector$SectorNumber$1$1({4}SL:U),R,0,0,[r2,r3,r4,r5]
S:LSD_ReadSector$c$1$1({1}SC:U),R,0,0,[r2]
S:LSD_ReadSector$i$1$1({1}SC:U),R,0,0,[r3]
S:LSD_ReadSector$count$1$1({2}SI:U),R,0,0,[r4,r5]
F:G$SD_WriteSector$0$0({2}DF,SC:U),Z,0,0,0,0,0
S:LSD_WriteSector$Buffer$1$1({3}DG,SC:U),B,1,-5
S:LSD_WriteSector$SectorNumber$1$1({4}SL:U),R,0,0,[r2,r3,r4,r5]
S:LSD_WriteSector$i$1$1({1}SC:U),R,0,0,[]
S:LSD_WriteSector$count$1$1({2}SI:U),R,0,0,[r5,r6]
F:G$SD_WaitForReady$0$0({2}DF,SC:U),Z,0,0,0,0,0
S:LSD_WaitForReady$i$1$1({1}SC:U),R,0,0,[r4]
S:LSD_WaitForReady$j$1$1({2}SI:U),R,0,0,[r2,r3]
T:Fsd$_FIL[({0}S:S$id$0$0({2}SI:U),Z,0,0)({2}S:S$flag$0$0({1}SC:U),Z,0,0)({3}S:S$sect_clust$0$0({1}SC:U),Z,0,0)({4}S:S$fs$0$0({3}DG,ST_FATFS:S),Z,0,0)({7}S:S$fptr$0$0({4}SL:U),Z,0,0)({11}S:S$fsize$0$0({4}SL:U),Z,0,0)({15}S:S$org_clust$0$0({4}SL:U),Z,0,0)({19}S:S$curr_clust$0$0({4}SL:U),Z,0,0)({23}S:S$curr_sect$0$0({4}SL:U),Z,0,0)]
T:Fsd$_DIR[({0}S:S$id$0$0({2}SI:U),Z,0,0)({2}S:S$index$0$0({2}SI:U),Z,0,0)({4}S:S$fs$0$0({3}DG,ST_FATFS:S),Z,0,0)({7}S:S$sclust$0$0({4}SL:U),Z,0,0)({11}S:S$clust$0$0({4}SL:U),Z,0,0)({15}S:S$sect$0$0({4}SL:U),Z,0,0)]
T:Fsd$__00010000[({0}S:S$Index$0$0({6}DA6,SC:U),Z,0,0)({0}S:S$CA$0$0({6}ST__00020001:S),Z,0,0)]
T:Fsd$__00010002[({0}S:S$b$0$0({4}DA4,SC:U),Z,0,0)({0}S:S$ul$0$0({4}SL:U),Z,0,0)]
T:Fsd$__00020001[({0}S:S$Command$1$0({1}SC:U),Z,0,0)({1}S:S$Argument$1$0({4}SL:U),Z,0,0)({5}S:S$Cksum$1$0({1}SC:U),Z,0,0)]
T:Fsd$_FILINFO[({0}S:S$fsize$0$0({4}SL:U),Z,0,0)({4}S:S$fdate$0$0({2}SI:U),Z,0,0)({6}S:S$ftime$0$0({2}SI:U),Z,0,0)({8}S:S$fattrib$0$0({1}SC:U),Z,0,0)({9}S:S$fname$0$0({13}DA13,SC:S),Z,0,0)]
T:Fsd$_FATFS[({0}S:S$id$0$0({2}SI:U),Z,0,0)({2}S:S$n_rootdir$0$0({2}SI:U),Z,0,0)({4}S:S$winsect$0$0({4}SL:U),Z,0,0)({8}S:S$fatbase$0$0({4}SL:U),Z,0,0)({12}S:S$dirbase$0$0({4}SL:U),Z,0,0)({16}S:S$database$0$0({4}SL:U),Z,0,0)({20}S:S$sects_fat$0$0({4}SL:U),Z,0,0)({24}S:S$max_clust$0$0({4}SL:U),Z,0,0)({28}S:S$fs_type$0$0({1}SC:U),Z,0,0)({29}S:S$sects_clust$0$0({1}SC:U),Z,0,0)({30}S:S$n_fats$0$0({1}SC:U),Z,0,0)({31}S:S$winflag$0$0({1}SC:U),Z,0,0)({32}S:S$win$0$0({512}DA512,SC:U),Z,0,0)]
T:Fsd$MAH[({0}S:S$next$0$0({2}DX,STMAH:S),Z,0,0)({2}S:S$len$0$0({2}SI:U),Z,0,0)({4}S:S$mem$0$0({0}DA0,SC:U),Z,0,0)]
S:LSD_GetR2$R2$1$1({2}SI:U),G,0,0
S:Fsd$lcdinstwrptr$0$0({1}SC:U),F,0,0
S:Fsd$lcdinstrdptr$0$0({1}SC:U),F,0,0
S:Fsd$lcddatawrptr$0$0({1}SC:U),F,0,0
S:Fsd$lcddatardptr$0$0({1}SC:U),F,0,0
...
S:G$gethex$0$0({2}DF,SI:U),C,0,0
S:G$atoi$0$0({2}DF,SI:S),C,0,0
S:G$atox$0$0({2}DF,SI:U),C,0,0
S:G$getnumber$0$0({2}DF,SI:U),C,0,0
S:G$getnumbetween$0$0({2}DF,SI:S),C,0,0
S:G$htoa$0$0({2}DF,SV:S),C,0,0
S:G$getline$0$0({2}DF,SB0$1:U),C,0,0
